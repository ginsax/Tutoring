...
public class SolutionMovementObjectModerate implements Movement {
	 ...
	 * 
	 * @param x
	 *          The value that will set as the coordinates object's x position.
	 * @param y
	 *          The value that will set as the coordinates object's y position.
	 * @param z
	 *          The value that will set as the coordinates object's z position.
	 */
	...
	public String createDisplayString() {
		...
		return String.format("%s [%d, %d, %d][%d, %d, %d]", mDisplayStringHeader, x,
		    y, z, modifiedX, modifiedY, modifiedZ);
	}
