...
public class SolutionMovementObjectModerate implements Movement {
	...
	/**
	 * Default constructor of a new SolutionMovementObjectModerate. Instantiates the
	 * coordinates object with the default x, y, & z values.
	 */
	...
	/**
	 * Alternate constructor of a new SolutionMovementObjectModerate. Allows for the
	 * setting of the coordinates object with the given {@code x}, {@code y}, &
	 * {@code z} values.
	 * 
	 ...
	 */
	public SolutionMovementObjectModerate(final int x, final int y, final int z) {
	...
	public String createDisplayString() {
		...
		return String.format("%s [%d, %d, %d][%d, %d, %d]", mDisplayStringHeader, x, y, z, modifiedX, modifiedY,
				modifiedZ);
	}
