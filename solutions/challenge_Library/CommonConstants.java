...
public final class CommonConstants {
	...
	/**
	 * The default value used for the publishing year of a book. Value =
	 * {@value #DEFAULT_PUBLISHING_YEAR}.
	 */
	final static int DEFAULT_PUBLISHING_YEAR = 0000;
	
	/**
	 * The default value used for the stock of a book. Value =
	 * {@value #DEFAULT_STOCK}.
	 */
	final static int DEFAULT_STOCK = -1;
	
	/**
	 * The default value used for the author of a book. Value =
	 * {@value #DEFAULT_AUTHOR}.
	 */
	final static String DEFAULT_AUTHOR = "No Author";
	
	/**
	 * The default value used for the ISBN of a book. Value =
	 * {@value #DEFAULT_ISBN}.
	 */
	final static String DEFAULT_ISBN = "000-0000000000";
	
	/**
	 * The default value used for the series of a book. Value =
	 * {@value #DEFAULT_SERIES}.
	 */
	final static String DEFAULT_SERIES = "No Series";
	
	/**
	 * The default value used for the title of a book. Value =
	 * {@value #DEFAULT_TITLE}.
	 */
	final static String DEFAULT_TITLE = "No Book Title";
	
	/**
	 * The default value used for the intended audience of a book. Value =
