...
public class IOModule {
	 ...
	 * 
	 * @param parsedResult
	 *          The parsed results that will be used to determine the intended
	 *          audience of a book.
	 ...
	 * 
	 * @param parsedResult
	 *          The parsed results that will be used to determine the author of a
	 *          book.
	 ...
	 * 
	 * @param parsedResult
	 *          The parsed results that will be used to determine the fictionality
	 *          of a book.
	 ...
	 * 
	 * @param parsedResult
	 *          The parsed results that will be used to determine the genre of a
	 *          book.
	 ...
	 * 
	 * @param parsedResult
	 *          The parsed results that will be used to determine the ISBN of a
	 *          book.
	 ...
	 * 
	 * @param parsedResults
	 *          The parsed results that will be used to determine the number of
	 *          copies of a book that are in stock.
	 * @param index
	 *          The index to use with the parsed results. Needs to be passed in to
	 *          avoid handling {@link IndexOutOfBoundsException
	 ...
	 * 
	 * @param parsedResults
	 *          The parsed results that will be used to determine the total number
	 *          of copies of a book.
	 * @param index
	 *          The index to use with the parsed results. Needs to be passed in to
	 *          avoid handling {@link IndexOutOfBoundsException
	 ...
	 * 
	 * @param parsedResult
	 *          The parsed results that will be used to determine the year a book
	 *          was published.
	 ...
	 * 
	 * @param parsedResult
	 *          The parsed results that will be used to determine the series - if
	 *          any - a book has a position in.
	 ...
	 * 
	 * @param parsedResult
	 *          The parsed results that will be used to determine the title of a
	 *          book.
	 ...
	 */
	public ObservableList<SolutionLibraryBook> retrieveBooksFromFile(
	    final String filePath) throws EmptyFileNameException {
		...
		try (BufferedReader reader = new BufferedReader(
			...
			while ((line = reader.readLine()) != null) {
				...
				final int publishingYear = parsePublishingYearFrom(
				    parsedResults[index++]);
				final Fictionality fictionality = parseFictionalityFrom(
				    parsedResults[index++]);
				final int numberOfCopiesInStock = parseNumberOfCopiesInStockFrom(
				    parsedResults, index++);
				final int numberOfCopiesTotal = parseNumberOfCopiesTotalFrom(
				    parsedResults, index++);
				
				final SolutionLibraryBook libraryBook = new SolutionLibraryBook(isbn,
				    title, author, series, genre, audience, publishingYear,
				    fictionality, numberOfCopiesInStock, numberOfCopiesTotal);
