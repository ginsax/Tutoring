...
public class IOModule {
	...
	/**
	 * Parses the given {@code parsedResult} to determine the intended audience of a
	 * book.
	 * 
	...
	/**
	 * Parses the given {@code parsedResult} to determine the fictionality of copies
	 * of a book.
	 * 
	 * @param parsedResult The parsed results that will be used to determine the
	...
	/**
	 * Parses the given {@code parsedResults} to determine the number of copies of a
	 * book that are in stock.
	 * 
	 * @param parsedResults The parsed results that will be used to determine the
	 *                      number of copies of a book that are in stock.
	 * @param index         The index to use with the parsed results. Needs to be
	 *                      passed in to avoid handling
	...
	public ObservableList<SolutionLibraryBook> retrieveBooksFromFile(final String filePath)
		...
		try (BufferedReader reader = new BufferedReader(
			...
			while ((line = reader.readLine()) != null) {
				...
				final SolutionLibraryBook libraryBook = new SolutionLibraryBook(isbn, title, author, series, genre,
						audience, publishingYear, fictionality, numberOfCopiesInStock, numberOfCopiesTotal);
