...
public class BookSeries implements Comparable<BookSeries> {
	...
	public BookSeries(final String seriesInformationToParse) throws InvalidBookSeriesNameException {
		...
		if ((seriesInformationToParse != null) && seriesInformationToParse.contains("|")) {
			try {
	...
	/**
	 * Creates a string containing user-friendly information about this book and its
	 * position with its series.
	 * 
	...
	public String getSeriesInformationString() {
		...
		final String seriesInformation = String.format(", book " + position + "/%d of %s", mPositionInSeries,
