...
public class SolutionLibraryBook implements Comparable<SolutionLibraryBook> {
	 ...
	 * 
	 * @param isbn
	 *          The unique international number assigned to this book.
	 * @param title
	 *          The title of this book.
	 * @param author
	 *          The author of this book.
	 * @param series
	 *          The series information of this book.
	 * @param genre
	 *          The genre of this book.
	 * @param audience
	 ...
	 * @param fictionality
	 *          The fictionality of this book.
	 * @param numberOfCopiesInStock
	 *          The number of copies of this book that are currently in stock.
	 * @param numberOfCopiesTotal
	 *          The total number of copies of this book.
	 */
	public SolutionLibraryBook(final String isbn, final String title,
	    final String author, final BookSeries series, final Genre genre,
	    final Audience audience, final int publishingYear,
	    final Fictionality fictionality, final int numberOfCopiesInStock,
	...
	public int compareTo(final SolutionLibraryBook otherBook) {
		...
		final int[] comparators = new int[] { comparisonAuthor, comparisonSeries,
		    comparisonTitle, };
	...
	public String toString() {
		...
		return String.format(
		    "%s [%s] (%d)%s by %s. %s %s - %s. [%d/%d] copies in stock.",
		    mTitle.get(), mISBN.get(), mPublishingYear.get(), seriesInformation,
		    mAuthor.get(), mAudience.get().toString(), mGenre.get().toString(),
		    mFictionality.get(), mNumberOfCopiesInStock.get(),
