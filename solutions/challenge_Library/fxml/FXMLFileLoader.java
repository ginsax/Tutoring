...
public class FXMLFileLoader {
     ...
     * <p>This implementation requires that the .fxml file has the same name as the .java file.
     * @param object Object which needs it's fxml files loaded.
     */
    public static void initFXMLfor(Object object) {
        final String className = getClassNameForLoading(object);
        
        FXMLLoader	fxmlLoader	= new FXMLLoader(object.getClass().getResource(className));
	 ...
	 * <p>Given an object, CustomFXMLLoader will load the fxml files related to it.
	 * @param object Object that needs it's fxml files loaded.
	 * @return The class name of <code>object</code>, as a string.
	 */
	public static	String getClassNameForLoading(Object object) {
