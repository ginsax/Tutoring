...
public class FXMLFileLoader {
	...
	public static String getClassNameForLoading(final Object object) {
		...
		final String pathName = String.format("/%s/fxml/%s.fxml", pathToFile.substring(0, index),
	...
	public static void initFXMLfor(final Object object) {
		...
		final FXMLLoader fxmlLoader = new FXMLLoader(object.getClass().getResource(className));
