...
public class Mammal extends Animal {
	...
	/**
	 * This is the constructor that will be used if the number of legs is not known,
	...
	/**
	 * Validates the various numbers of legs and ensures that only valid amounts are
	 * accepted.
	 */
