...
public class Mammal extends Animal {
	 ...
	 * 
	 * @param dietType
	 *          The type of diet this mammal has.
	 * @param skinType
	 *          The type of skin this mammal has.
	 */
	...
	/**
	 * This is the constructor that will be used if the number of legs & skin and
	 * diet types are known.
	 * 
	 * @param numberOfLegs
	 *          The number of legs this mammal has.
	 * @param dietType
	 *          The type of diet this mammal has.
	 * @param skinType
	 *          The type of skin this mammal has.
	 */
	public Mammal(final int numberOfLegs, final DietType dietType,
	...
	/**
	 * Validates the various numbers of legs and ensures that only valid amounts
	 * are accepted.
	 */
