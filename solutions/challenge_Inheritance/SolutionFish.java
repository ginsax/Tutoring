...
public class SolutionFish extends Animal {
	 ...
	 * 
	 * @param dietType
	 *          The type of diet this fish has.
	 * @param skinType
	 *          The type of skin this fish has.
	 */
	...
	/**
	 * This is the constructor that will be used if the number of fins & skin and
	 * diet types are known.
	 * 
	 * @param numberOfFins
	 *          The number of legs this fish has.
	 * @param dietType
	 *          The type of diet this fish has.
	 * @param skinType
	 *          The type of skin this fish has.
	 */
	public SolutionFish(final int numberOfFins, final DietType dietType,
	...
	/**
	 * Validates the various numbers of fins and ensures that only valid amounts
	 * are accepted.
	 */
