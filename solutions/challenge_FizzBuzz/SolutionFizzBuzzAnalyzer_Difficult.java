...
public class SolutionFizzBuzzAnalyzer_Difficult {
	 ...
	 * 
	 * @param boundsLower Lower bounds of this analysis. If the given value is less
	 *                    than 0, then it is set to 0.
	 * @param boundsUpper Upper bounds of this analysis. If the given value is
	 *                    greater than 1000, then it is set to 1000.
	 */
	public SolutionFizzBuzzAnalyzer_Difficult(final int boundsLower, final int boundsUpper) {
