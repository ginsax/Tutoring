...
public class SolutionFizzBuzzAnalyzer_Difficult {
	...
	/**
	 * Constructor of the difficult Fizz Buzz Analyzer. Allows for the setting of
	 * upper and lower bounds.
	 * 
	 * @param boundsLower
	 *          Lower bounds of this analysis. If the given value is less than 0,
	 *          then it is set to 0.
	 * @param boundsUpper
	 *          Upper bounds of this analysis. If the given value is greater than
	 *          1000, then it is set to 1000.
	 */
	 ...
	 * FizzBuzzObjects. FizzBuzzObjects will be sorted in order of their integer
	 * 'value' property.
	 * 
	 * @param fizzBuzzObjects
	 *          Any number of FizzBuzzObjects to be used in this analysis.
	 * @return Return a string message containing the values returned by the given
	 *         {@code fizzBuzzObjects}.
	 */
