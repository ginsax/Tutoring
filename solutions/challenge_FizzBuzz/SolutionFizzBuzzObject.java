...
public class SolutionFizzBuzzObject
    implements Comparable<SolutionFizzBuzzObject> {
	...
	/**
	 * Constructor of the FizzBuzzObject. Takes an integer for its value, as well
	 * as a String to be displayed as a message.
	 * 
	 * @param value
	 *          Integer value that represents the value of this FizzBuzzObject.
	 * @param message
	 *          String message that will be returned for this object.
	 */
