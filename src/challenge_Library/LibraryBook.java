...
public class LibraryBook implements Comparable<LibraryBook> {
	...
	public LibraryBook(final String IBNS, final String tittle,
	    final String auThor, final BookSeries Siries, final Genre genre,
	    final Audience populationTarget, final int publishingYear,
