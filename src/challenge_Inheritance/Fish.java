...
public class Fish extends Animal {
	...
	/**
	 * This is the constructor that will be used if the number of fins is not known,
	 * but the skin and diet types are known.
	 * 
	...
	/**
	 * Validates the various numbers of fins and ensures that only valid amounts are
	 * accepted.
	 */
