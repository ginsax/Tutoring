...
public class FizzBuzzObject implements Comparable<FizzBuzzObject> {
	 ...
	 * 
	 * @param FiBu
	 *          is the array of FizzBuzzObjects to be sorted
	 ...
	 * 
	 * @param multipleInput
	 *          Dictates the multiple on which this FizzBuzzObject will refer to
	 *          (in the classic example, "3" is Fizz' multiple.)
	 * @param callSignInput
	 *          Dictates the callsign that the multiple will respond with (in the
	 *          classic example, "Fizz" is 3's response)
	 */
