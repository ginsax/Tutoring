...
public class FizzBuzzObject implements Comparable<FizzBuzzObject> {
	...
	/**
	 * Constructor for a FizzBuzzObject. This object will be used as a configuration
	 * input for a multiple/callsign combination in a fizzbuzz analysis class.
	 * 
	 * @param multipleInput Dictates the multiple on which this FizzBuzzObject will
	 *                      refer to (in the classic example, "3" is Fizz'
	 *                      multiple.)
	 * @param callSignInput Dictates the callsign that the multiple will respond
	 *                      with (in the classic example, "Fizz" is 3's response)
	 */
	public FizzBuzzObject(final int multipleInput, final String callSignInput) {
	...
	public String toString() {
		...
		final String post = "]";
		final String returnString = header + Integer.toString(multiple) + ", " + callSign + post;
		return returnString;
	}
