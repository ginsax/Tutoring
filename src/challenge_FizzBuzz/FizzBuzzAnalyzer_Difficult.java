...
public class FizzBuzzAnalyzer_Difficult {
	 ...
	 */
	public FizzBuzzAnalyzer_Difficult(int myLower,
	                                  int myUpper) {
		if (myLower > myUpper) {
	...
	/**
	 * Analyzes a set of FizzBuzz multiple/callsign combinations between bounds
	 * set for FizzBuzzAnalyzer_Difficult object.
	 * @param fiBu Inputs an unbounded comma separated set of FizzBuzzObject
