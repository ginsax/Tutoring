...
public class MovementObjectModerate implements Movement {
  ...
  public String createDisplayString() {
    ...
    final int xMod = xMove *
                     yMove;
    final int yMod = yMove *
                     zMove;
    final int zMod = zMove *
                     xMove;
    // Assemble final string.
    final String displayString = displayString1 +
                                 xMove +
                                 ", " +
                                 yMove +
                                 ", " +
  ...
  public void move() {
    ...
    mModCoordinates.setPositionX(currentX *
                                 xMove);
    mModCoordinates.setPositionY(currentY *
                                 yMove);
    mModCoordinates.setPositionZ(currentZ *
                                 zMove);
  }
}