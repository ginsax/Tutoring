...
//		Task_1:Create anti-string
		...
		for(int i=potentialPalindrome.length()-1;i>=0;i--){
			bizzaroString=bizzaroString+potentialPalindrome.charAt(i);
		}
//		Task_2: compare inverted string with original to see if they match (therefore palindrome)
//		Do not differentiate between lower and upper case.
		boolean doPalindromesMatch=potentialPalindrome.equalsIgnoreCase(bizzaroString);
