...
public class Animal {
	...
	/**
	 * This is the constructor that will be used most often. It is the only 
	 * way to assign values that should be considered constants.
	 * @param dietType The type of diet this animal has.
	 * @param skinType The type of skin this animal has.
	 */
	public Animal(final DietType dietType, final SkinType skinType) {
		mDietType = dietType;
		mSkinType = skinType;
	}
