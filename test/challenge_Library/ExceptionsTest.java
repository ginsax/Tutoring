...
public class ExceptionsTest {
	...
	public void test_EmptyFileNameException_CanHaveCustomMessage() {
		...
		assertEquals("Tests that a EmptyFileNameException can have a message set.", expected, actual);
	}
	...
	public void test_InvalidBookSeriesNameException_CanHaveCustomMessage() {
		...
		final String actual = exception.getMessage();
		assertEquals("Tests that a InvalidBookSeriesNameException can have a message set.", expected, actual);
	}
