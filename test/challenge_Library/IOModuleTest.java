...
public class IOModuleTest {
	 ...
	 */
	@Test
	public void test_IOModule_HandlesInvalid_Audience() throws EmptyFileNameException {
		final ObservableList<SolutionLibraryBook> retrievedBooks = mIOModule.retrieveBooksFromFile("InvalidTest.csv");
	...
	/**
	 * Tests that IOModule will replace an invalid book author with the default book
	 * author value.
	 * 
	 * @throws EmptyFileNameException
	 */
	@Test
	public void test_IOModule_HandlesInvalid_Author() throws EmptyFileNameException {
		final ObservableList<SolutionLibraryBook> retrievedBooks = mIOModule.retrieveBooksFromFile("InvalidTest.csv");
	 ...
	 */
	@Test
	public void test_IOModule_HandlesInvalid_Fictionality() throws EmptyFileNameException {
		final ObservableList<SolutionLibraryBook> retrievedBooks = mIOModule.retrieveBooksFromFile("InvalidTest.csv");
		...
		assertEquals(
				"Tests that IOModule will replace an invalid book fictionality with the default book fictionality.",
				expected, actual);
	}

	/**
	 * Tests that IOModule will replace an invalid book genre with the default book
	 * genre.
	 * 
	 * @throws EmptyFileNameException
	 */
	@Test
	public void test_IOModule_HandlesInvalid_Genre() throws EmptyFileNameException {
		final ObservableList<SolutionLibraryBook> retrievedBooks = mIOModule.retrieveBooksFromFile("InvalidTest.csv");

		final Genre expected = CommonConstants.DEFAULT_GENRE;
		final Genre actual = retrievedBooks.get(4).getGenre();

		assertEquals("Tests that IOModule will replace an invalid book genre with the default book genre.", expected,
				actual);
	}

	/**
	 * Tests that IOModule will replace an invalid ISBN value with the default ISBN
	 * value.
	 * 
	 * @throws EmptyFileNameException
	 */
	@Test
	public void test_IOModule_HandlesInvalid_ISBN() throws EmptyFileNameException {
		final ObservableList<SolutionLibraryBook> retrievedBooks = mIOModule.retrieveBooksFromFile("InvalidTest.csv");

		final String expected = CommonConstants.DEFAULT_ISBN;
		final String actual = retrievedBooks.get(0).getISBN();

		assertEquals("Tests that IOModule will replace an invalid ISBN value with the default ISBN value.", expected,
				actual);
	}

	/**
	 * Tests that IOModule will replace an invalid number of books in stock with the
	 * default number of books in stock value.
	 * 
	 * @throws EmptyFileNameException
	 */
	@Test
	public void test_IOModule_HandlesInvalid_NumberOfCopiesInStock() throws EmptyFileNameException {
		final ObservableList<SolutionLibraryBook> retrievedBooks = mIOModule.retrieveBooksFromFile("InvalidTest.csv");
		...
		assertEquals(
				"Tests that IOModule will replace an invalid number of books in stock with the default number of books in stock value.",
				expected, actual);
	}

	/**
	 * Tests that IOModule will replace an invalid book total stock with the default
	 * book total stock value.
	 * 
	 * @throws EmptyFileNameException
	 */
	@Test
	public void test_IOModule_HandlesInvalid_NumberOfCopiesTotal() throws EmptyFileNameException {
		final ObservableList<SolutionLibraryBook> retrievedBooks = mIOModule.retrieveBooksFromFile("InvalidTest.csv");
		...
		assertEquals(
				"Tests that IOModule will replace an invalid book total stock with the default book total stock value.",
				expected, actual);
	}
	 ...
	 */
	@Test
	public void test_IOModule_HandlesInvalid_PublishingYear() throws EmptyFileNameException {
		final ObservableList<SolutionLibraryBook> retrievedBooks = mIOModule.retrieveBooksFromFile("InvalidTest.csv");
		...
		assertEquals(
				"Tests that IOModule will replace an invalid book publishing year with the default book publishing year value.",
				expected, actual);
	}

	/**
	 * Tests that IOModule will replace an invalid book series with the default book
	 * series value.
	 * 
	 * @throws EmptyFileNameException
	 */
	@Test
	public void test_IOModule_HandlesInvalid_Series() throws EmptyFileNameException {
		final ObservableList<SolutionLibraryBook> retrievedBooks = mIOModule.retrieveBooksFromFile("InvalidTest.csv");
	...
	/**
	 * Tests that IOModule will replace an invalid book title with the default book
	 * title value.
	 * 
	 * @throws EmptyFileNameException
	 */
	@Test
	public void test_IOModule_HandlesInvalid_Title() throws EmptyFileNameException {
		final ObservableList<SolutionLibraryBook> retrievedBooks = mIOModule.retrieveBooksFromFile("InvalidTest.csv");
	...
	public void test_IOModule_RetrievedListIsNotNullWhenFileNameIsCorrect() throws EmptyFileNameException {
		final ObservableList<SolutionLibraryBook> retrievedBooks = mIOModule.retrieveBooksFromFile("Test.csv");
	...
	public void test_IOModule_ReturnedListIsNotEmpty_WhenEmptyFileNameIsGiven() throws EmptyFileNameException {
	 ...
	 */
	@Test(expected = EmptyFileNameException.class)
	public void test_IOModule_ReturnedListIsNull_WhenEmptyFileNameIsGiven() throws EmptyFileNameException {
		final ObservableList<SolutionLibraryBook> retrievedBooks = mIOModule.retrieveBooksFromFile("");

		assertNull(retrievedBooks);
	}

	/**
	 * Tests that IOModule will throw a EmptyFileNameException if an incorrect file
	 * name is given.
	 * 
	 * @throws EmptyFileNameException
	 */
	@Test(expected = EmptyFileNameException.class)
	public void test_IOModule_ThrowsEmptyFileNameException_WhenFileNameIsIncorrect() throws EmptyFileNameException {
	 ...
	 */
	@Test(expected = EmptyFileNameException.class)
	public void test_IOModule_ThrowsEmptyFileNameException_WhenFileNameIsInvalid() throws EmptyFileNameException {
	 ...
	 */
	@Test(expected = EmptyFileNameException.class)
	public void test_IOModule_ThrowsEmptyFileNameException_WhenFileNameIsNull() throws EmptyFileNameException {
