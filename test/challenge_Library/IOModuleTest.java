...
public class IOModuleTest {
	...
	public void test_IOModule_HandlesInvalid_Audience()
		...
		assertEquals(
		    "Tests that IOModule will replace an invalid book audience with the default book audience.",
		    expected, actual);
	}
	...
	public void test_IOModule_HandlesInvalid_Author()
		...
		assertEquals(
		    "Tests that IOModule will replace an invalid book author with the default book author value.",
		    expected, actual);
	}
	...
	public void test_IOModule_HandlesInvalid_Genre()
		...
		assertEquals(
		    "Tests that IOModule will replace an invalid book genre with the default book genre.",
		    expected, actual);
	}
	...
	public void test_IOModule_HandlesInvalid_ISBN()
		...
		assertEquals(
		    "Tests that IOModule will replace an invalid ISBN value with the default ISBN value.",
		    expected, actual);
	}
	...
	public void test_IOModule_HandlesInvalid_Series()
		...
		assertEquals(
		    "Tests that IOModule will replace an invalid book series with the default book series value.",
		    expected, actual);
	}
	...
	public void test_IOModule_HandlesInvalid_Title()
		...
		assertEquals(
		    "Tests that IOModule will replace an invalid book title with the default book title value.",
		    expected, actual);
	}
