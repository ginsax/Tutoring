...
public class LibraryControllerTest {
   ...
   */
  @Test
  public void test_LibraryController_CanHandleLoadingNullFileName() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
  ...
  @SuppressWarnings("unchecked")
  @Test
  public void test_LibraryController_CanClearFilters() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
    mLibraryController = new LibraryController("SimpleTest.csv");
    ...
    for (Field field : LibraryController.class.getDeclaredFields()) {
      ...
      if (field.getType().equals(TextField.class) && 
        ...
        assertEquals("Tests that an unfiltered table has 6 items.", 
            expected, 
            actual);
        ...
        assertEquals("Tests that a filtered table has only 1 item.", 
            expected, 
            actual);
        ...
        expected = 8;
        actual = tableView.getItems().size();
        assertEquals("Tests that clearing the filters will restore the table to having all 8 items.", 
            expected, 
            actual);
      }
    }
  ...
  /**
   * Tests that the title filter text field of a library controller is not 
   * null.
   * @throws EmptyFileNameException if the given {@code fileName} is empty.
   * @throws IllegalAccessException 
   * @throws IllegalArgumentException 
   */
  @Test
  public void test_LibraryController_FilterTextBox_Title_IsNotNull() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException {
    mLibraryController = new LibraryController("SimpleTest.csv");
    ...
    for (Field field : fields) {
      ...
      if (field.getType().equals(TextField.class) && 
        ...
        assertNotNull("Tests that the title filter text field of a library controller is not null.", 
                       textField);
      }
    }
  }
  /**
   * Tests that the author filter text field of a library controller is not 
   * null.
   * @throws EmptyFileNameException if the given {@code fileName} is empty.
   * @throws IllegalAccessException 
   * @throws IllegalArgumentException 
   */
  @Test
  public void test_LibraryController_FilterTextBox_Author_IsNotNull() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException {
    mLibraryController = new LibraryController("SimpleTest.csv");
   ...
   */
  @Test
  public void test_LibraryController_FilterTextBox_Year_IsNotNull() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException {
    mLibraryController = new LibraryController("SimpleTest.csv");
  ...
  /**
   * Tests that the ISBN-13 filter text field of a library controller is not 
   * null.
   * @throws EmptyFileNameException if the given {@code fileName} is empty.
   * @throws IllegalAccessException 
   * @throws IllegalArgumentException 
   */
  @Test
  public void test_LibraryController_FilterTextBox_ISBN_IsNotNull() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException {
    mLibraryController = new LibraryController("SimpleTest.csv");
  ...
  @SuppressWarnings("unchecked")
  @Test
  public void test_LibraryController_FilterComboBox_Genre_IsNotNull() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException {
    mLibraryController = new LibraryController("SimpleTest.csv");
  ...
  @SuppressWarnings("unchecked")
  @Test
  public void test_LibraryController_FilterComboBox_Audience_IsNotNull() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException {
    mLibraryController = new LibraryController("SimpleTest.csv");
   ...
   */
  @Test
  public void test_LibraryController_InStockCheckBox_IsNotNull() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException {
    mLibraryController = new LibraryController("SimpleTest.csv");
    ...
    for (Field field : fields) {
      ...
      if (field.getType().equals(CheckBox.class)) {
        ...
        assertNotNull("Tests that checkbox of a library controller is not null.", 
            toggleButton);
      }
    }
  }
  ...
  @SuppressWarnings("unchecked")
  @Test
  public void test_LibraryController_FilterTextBox_Title_FiltersCorrectly() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException {
    mLibraryController = new LibraryController("SimpleTest.csv");
  ...
  /**
   * Tests that the author filter text field of a library controller filters 
   * as expected.
   * @throws EmptyFileNameException
   * @throws IllegalAccessException 
   * @throws IllegalArgumentException 
  ...
  @SuppressWarnings("unchecked")
  @Test
  public void test_LibraryController_FilterTextBox_Author_FiltersCorrectly() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException {
    mLibraryController = new LibraryController("SimpleTest.csv");
    ...
    for (Field field : fields) {
      ...
      if (field.getType().equals(TextField.class) && 
        ...
        expected = 2;
        actual = tableView.getItems().size();
        assertEquals("Tests that a filtered table has only 2 items.", 
            expected, 
            actual);
  ...
  @SuppressWarnings("unchecked")
  @Test
  public void test_LibraryController_FilterTextBox_PublishingYear_FiltersCorrectly() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException {
    mLibraryController = new LibraryController("SimpleTest.csv");
  ...
  /**
   * Tests that the ISBN-13 filter text field of a library controller filters 
   * as expected.
   * @throws EmptyFileNameException
   * @throws IllegalAccessException 
   * @throws IllegalArgumentException 
  ...
  @SuppressWarnings("unchecked")
  @Test
  public void test_LibraryController_FilterTextBox_ISBN_FiltersCorrectly() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException {
    mLibraryController = new LibraryController("SimpleTest.csv");
  ...
  @SuppressWarnings("unchecked")
  @Test
  public void test_LibraryController_ComboBox_Genre_FiltersCorrectly() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException {
    mLibraryController = new LibraryController("SimpleTest.csv");
  ...
  @SuppressWarnings("unchecked")
  @Test
  public void test_LibraryController_ComboBox_Audience_FiltersCorrectly() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException {
    mLibraryController = new LibraryController("SimpleTest.csv");
  ...
  @SuppressWarnings("unchecked")
  @Test
  public void test_LibraryController_InStockCheckBoxFiltersCorrectly() throws EmptyFileNameException, IllegalArgumentException, IllegalAccessException {
    mLibraryController = new LibraryController("SimpleTest.csv");
    ...
    for (Field field : fields) {
      ...
      if (field.getType().equals(CheckBox.class)) {
        ...
        expected = 5;
        actual = tableView.getItems().size();
        assertEquals("Tests that a filtered table has only 3 items.", 
            expected, 
            actual);
