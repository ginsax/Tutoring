...
public class BookSeriesTest {
	 ...
	 * only if - the title, position within, and total number of books in series are
	 * all the same.
	 * 
	 * @throws InvalidBookSeriesNameException
	 */
	@Test
	public void test_BookSeries_ComparesTo_AnotherBookSeries_Equally() throws InvalidBookSeriesNameException {
		...
		assertEquals(
				"Tests that a book series compares to another book series as equal if - and only if - the title, position within, and total number of books in series are all the same.",
				expected, actual);
	}
	...
	public void test_BookSeries_ComparesTo_AnotherBookSeries_GreaterThanPosition()
		...
		assertEquals(
				"Tests that a book series compares to another book series as greater than if the position within the series is greater than the other book series position.",
				expected, actual);
	}
	 ...
	 */
	@Test
	public void test_BookSeries_ComparesTo_AnotherBookSeries_GreaterThanTitle() throws InvalidBookSeriesNameException {
		...
		assertEquals(
				"Tests that a book series compares to another book series as greater than if the title is greater than the other book series title.",
				expected, actual);
	}

	/**
	 * Tests that a book series compares to another book series as greater than if
	 * the total number of books in the series are greater than the total number of
	 * books in the other book series.
	 * 
	 * @throws InvalidBookSeriesNameException
	 */
	@Test
	public void test_BookSeries_ComparesTo_AnotherBookSeries_GreaterThanTotal() throws InvalidBookSeriesNameException {
		...
		assertEquals(
				"Tests that a book series compares to another book series as greater than if the total number of books in the series are greater than the total number of books in the other book series.",
				expected, actual);
	}

	/**
	 * Tests that a book series compares to another book series as less than if the
	 * position within is less than the other book series position.
	 * 
	 * @throws InvalidBookSeriesNameException
	 */
	@Test
	public void test_BookSeries_ComparesTo_AnotherBookSeries_LessThanPosition() throws InvalidBookSeriesNameException {
		...
		assertEquals(
				"Tests that a book series compares to another book series as less than if the position within the series is less than the other book series position.",
				expected, actual);
	}

	/**
	 * Tests that a book series compares to another book series as less than if the
	 * title is less than the other book series title.
	 * 
	 * @throws InvalidBookSeriesNameException
	 */
	@Test
	public void test_BookSeries_ComparesTo_AnotherBookSeries_LessThanTitle() throws InvalidBookSeriesNameException {
		final BookSeries otherBookSeries = new BookSeries("Test Series 1|3");
		...
		assertEquals(
				"Tests that a book series compares to another book series as less than if the title is less than the other book series title.",
				expected, actual);
	}

	/**
	 * Tests that a book series compares to another book series as less than if the
	 * total number of books in the series are less than the total number of books
	 * in the other book series.
	 * 
	 * @throws InvalidBookSeriesNameException
	 */
	@Test
	public void test_BookSeries_ComparesTo_AnotherBookSeries_LessThanTotal() throws InvalidBookSeriesNameException {
		final BookSeries otherBookSeries = new BookSeries("Test Series 1|3");
		...
		assertEquals(
				"Tests that a book series compares to another book series as less than if the total number of books in the series are less than the total number of books in the other book series.",
				expected, actual);
	}
	 ...
	 */
	@Test
	public void test_BookSeries_InformationString_IsNotEmpty() throws InvalidBookSeriesNameException {
		mBookSeries = new BookSeries("Test Book Series 1|1");
		final String expected = "";
		final String actual = mBookSeries.getSeriesInformationString();

		assertNotEquals("Tests that the information string of a book series is not an empty string.", expected, actual);
	}
	 ...
	 */
	@Test
	public void test_BookSeries_InformationString_IsNotString() throws InvalidBookSeriesNameException {
		mBookSeries = new BookSeries("Test Book Series 1.50|2");
		final String expected = ", book 1.5/2 of Test Book Series";
		final String actual = mBookSeries.getSeriesInformationString();

		assertEquals("Tests that the information string of a book series can handle a floating point number.", expected,
				actual);
	}
	 ...
	 */
	@Test
	public void test_BookSeries_IsPartOfSeries() throws InvalidBookSeriesNameException {
		mBookSeries = new BookSeries("Test Book Series 1|1");

		assertTrue("Tests that a book series is considered as part of a series.", mBookSeries.isPartOfASeries());
	}
	...
	public void test_BookSeries_Name_HandlesIncompleteName() {
		...
		assertEquals(
				"Tests that the series name of a book series handles when a series name is not null, but is missing a '|'.",
				expected, actual);
	}
	...
	public void test_BookSeries_Name_HandlesInvalidName() throws InvalidBookSeriesNameException {
	...
	public void test_BookSeries_Name_HandlesNullName() {
		...
		assertEquals("Tests that the series name of a book series handles a null value.", expected, actual);
	}
	...
	public void test_BookSeries_Name_HasCorrectValue() {
		...
		assertEquals("Tests that the series name of a book series has the correct value.", expected, actual);
	}
	...
	public void test_DefaultBookSeries_ComparesTo_AnotherDefaultBookSeries_Equally() {
		...
		assertEquals(
				"Tests that a book series created with the default constructor compares to another default book series as equal, as long as the title is the same.",
				expected, actual);
	}
	...
	public void test_DefaultBookSeries_InformationString_IsEmptyString() {
		...
		assertEquals(
				"Tests that the information string of a book series created with the default constructor is an empty string.",
				expected, actual);
	}
	...
	public void test_DefaultBookSeries_IsNotPartOfSeries() {
		assertFalse(
				"Tests that a book series created with the default constructor is not considered as part of a series.",
	...
	public void test_DefaultBookSeries_Name_HasDefaultValue() {
		...
		assertEquals(
				"Tests that the series name of a book series created with the default constructor has the correct value.",
				expected, actual);
	}
	...
	public void test_DefaultBookSeries_SeriesProperty_HasDefaultValue() {
		...
		assertEquals(
				"Tests that the series property of a book series created with the default constructor is not null.",
				expected, actual);
	}
