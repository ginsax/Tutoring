...
public class BookSeriesTest {
	...
	public void test_BookSeries_InformationString_IsNotString()
		...
		assertEquals(
		    "Tests that the information string of a book series can handle a floating point number.",
		    expected, actual);
	}
	...
	public void test_DefaultBookSeries_Name_IsNotNull() {
		assertNotNull(
		    "Tests that the series name of a book series created with the default constructor is not null.",
