...
public class BookSeriesTest {
  ...
  /**
   * Tests that the information string of a book series created with the 
  ...
  /**
   * Tests that a book series compares to another book series as equal if - 
   * and only if - the title, position within, and total number of books in 
   * series are all the same.
   * @throws InvalidBookSeriesNameException 
   */
  @Test
   ...
   */
  @Test
  public void test_BookSeries_ComparesTo_AnotherBookSeries_GreaterThanPosition() throws InvalidBookSeriesNameException {
    final BookSeries otherBookSeries  = new BookSeries("Test Series 1|3");
