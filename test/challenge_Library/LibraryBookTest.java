...
public class LibraryBookTest {
	...
	public void test_DefaultLibraryBook_Audience_IsNotNull() {
		assertNotNull(
		    "Tests that the ISBN of a library book created with the default constructor is not null.",
	...
	public void test_DefaultLibraryBook_Author_IsNotNull() {
		assertNotNull(
		    "Tests that the author of a library book created with the default constructor is not null.",
	...
	public void test_DefaultLibraryBook_Fictionality_IsNotNull() {
		assertNotNull(
		    "Tests that the fictionality of a library book created with the default constructor is not null.",
	...
	public void test_DefaultLibraryBook_ID_IsNotNull() {
		assertNotNull(
		    "Tests that the unique ID of a library book created with the default constructor is not null.",
	...
	public void test_DefaultLibraryBook_Series_IsNotNull() {
		assertNotNull(
		    "Tests that the series of a library book created with the default constructor is not null.",
	...
	public void test_DefaultLibraryBook_Title_IsNotNull() {
		assertNotNull(
		    "Tests that the title of a library book created with the default constructor is not null.",
	...
	public void test_LibraryBook_Audience_HasCorrectAssignedValue() {
		mLibraryBook = new LibraryBook("978-0575097469", "Warbreaker",
		    "Brandon Sanderson", new BookSeries(), Genre.Fantasy, Audience.Adult,
		    2011, Fictionality.Fiction, 1, 5);
	...
	public void test_LibraryBook_Author_HasCorrectAssignedValue() {
		mLibraryBook = new LibraryBook("978-0765383105", "Elantris",
		    "Brandon Sanderson", new BookSeries(), Genre.Fantasy, Audience.Adult,
		    2005, Fictionality.Fiction, 2, 3);
	...
	public void test_LibraryBook_Compares_Correctly_With_SameBook() {
		...
		try {
			...
			mLibraryBook = new LibraryBook("978-0812511819", "The Eye of the World",
			    "Robert Jordan", new BookSeries("The Wheel of Time 1|14"),
			    Genre.Fantasy, Audience.Adult, 1990, Fictionality.Fiction, 1, 2);
			otherBook = new LibraryBook("978-0812511819", "The Eye of the World",
			    "Robert Jordan", new BookSeries("The Wheel of Time 1|14"),
			    Genre.Fantasy, Audience.Adult, 1990, Fictionality.Fiction, 1, 2);
	...
	public void test_LibraryBook_Compares_Correctly_With_Sequel() {
		...
		try {
			mLibraryBook = new LibraryBook("978-0812511819", "The Eye of the World",
			    "Robert Jordan", new BookSeries("The Wheel of Time 1|14"),
			    Genre.Fantasy, Audience.Adult, 1990, Fictionality.Fiction, 1, 2);
			otherBook = new LibraryBook("978-0812517729", "The Great Hunt",
			    "Robert Jordan", new BookSeries("The Wheel of Time 2|14"),
			    Genre.Fantasy, Audience.Adult, 1991, Fictionality.Fiction, 2, 2);
		} catch (final InvalidBookSeriesNameException e) {
		}
	...
	public void test_LibraryBook_Fictionality_HasCorrectAssignedValue() {
		try {
			mLibraryBook = new LibraryBook("978-1524104863", "White Sand: Volume 1",
			    "Brandon Sanderson", new BookSeries("White Sand 1|2"), Genre.Fantasy,
			    Audience.YoungAdult, 2017, Fictionality.Fiction, 3, 3);
		} catch (final InvalidBookSeriesNameException e) {
		}
		...
		assertEquals(
		    "Tests that the number of in stock copies of a library book has the correct assigned value.",
		    expected, actual);
	}
	...
	public void test_LibraryBook_Genre_HasCorrectAssignedValue() {
		try {
			mLibraryBook = new LibraryBook("978-0385743570", "Steelheart",
			    "Brandon Sanderson", new BookSeries("The Reckoners 1|4"),
			    Genre.Fantasy, Audience.Adult, 2014, Fictionality.Fiction, 2, 5);
		} catch (final InvalidBookSeriesNameException e) {
		}
	...
	public void test_LibraryBook_ISBN_HasCorrectAssignedValue() {
		mLibraryBook = new LibraryBook("978-0399555770", "Skyward",
		    "Brandon Sanderson", new BookSeries(), Genre.Fantasy, Audience.Adult,
		    2018, Fictionality.Fiction, 4, 5);
	...
	public void test_LibraryBook_NumberOfCopiesInStock_HasCorrectAssignedValue() {
		try {
			mLibraryBook = new LibraryBook("978-0439925509",
			    ...
			    Genre.Fantasy, Audience.YoungAdult, 2007, Fictionality.Fiction, 2, 5);
		} catch (final InvalidBookSeriesNameException e) {
		}
	...
	public void test_LibraryBook_NumberOfCopiesTotal_HasCorrectAssignedValue() {
		mLibraryBook = new LibraryBook("978-0765338440", "The Rithmatist",
		    "Brandon Sanderson", new BookSeries(), Genre.Drama, Audience.YoungAdult,
		    2012, Fictionality.Fiction, 1, 3);
		
		final int expected = 3;
		final int actual = mLibraryBook.getNumberOfCopiesTotal();
		
		assertEquals(
		    "Tests that the number of total copies of a library book has the correct assigned value.",
		    expected, actual);
	}
	...
	public void test_LibraryBook_PublishingYear_HasCorrectAssignedValue() {
		mLibraryBook = new LibraryBook("978-1473218055",
		    ...
		    new BookSeries(), Genre.Fantasy, Audience.Adult, 2017,
		    Fictionality.Fiction, 1, 2);
		
		final int expected = 2017;
		final int actual = mLibraryBook.getPublishingYear();
		
		assertEquals(
		    "Tests that the publishing year of a library book has the correct assigned value.",
		    expected, actual);
	}
	...
	public void test_LibraryBook_Series_HasCorrectAssignedValue() {
		try {
			mLibraryBook = new LibraryBook("978-0765311788",
			    ...
			    new BookSeries("Mistborn: Era 1 1|3"), Genre.Fantasy, Audience.Adult,
			    2006, Fictionality.Fiction, 4, 6);
		} catch (final InvalidBookSeriesNameException e) {
		}
	...
	public void test_LibraryBook_Title_HasCorrectAssignedValue() {
		try {
			mLibraryBook = new LibraryBook("978-0765326355", "The Way of Kings",
			    "Brandon Sanderson", new BookSeries("The Stormlight Archive 1|10"),
			    Genre.Fantasy, Audience.Adult, 2010, Fictionality.Fiction, 7, 11);
		} catch (final InvalidBookSeriesNameException e) {
		}
	...
	public void test_LibraryBook_ToString_Matches() {
		mLibraryBook = new LibraryBook("978-1616960926", "The Emperor's Soul",
		    "Brandon Sanderson", new BookSeries(), Genre.Fantasy, Audience.Adult,
		    2012, Fictionality.Fiction, 2, 3);
		...
		for (final Field field : declaredFields) {
			if (!field.isSynthetic() && (Modifier.isPublic(field.getModifiers())
				...
				final String message = String.format(
				    "Field %s can only be public if it is also final.",
				    field.getName());
