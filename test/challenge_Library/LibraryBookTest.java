...
public class LibraryBookTest {
	...
	public void test_DefaultLibraryBook_Audience_HasDefaultValue() {
		...
		assertEquals(
				"Tests that the audience of a library book created with the default constructor has the default value.",
				expected, actual);
	}
	...
	/**
	 * Tests that the author of a library book created with the default constructor
	...
	public void test_DefaultLibraryBook_Author_HasDefaultValue() {
		...
		assertEquals(
				"Tests that the author of a library book created with the default constructor has the default value.",
				expected, actual);
	}
	...
	public void test_DefaultLibraryBook_Fictionality_HasDefaultValue() {
		...
		assertEquals(
				"Tests that the fictionality of a library book created with the default constructor has the default value.",
				expected, actual);
	}
	...
	public void test_DefaultLibraryBook_Genre_HasDefaultValue() {
		...
		assertEquals(
				"Tests that the genre of a library book created with the default constructor has the default value.",
				expected, actual);
	}
	...
	public void test_DefaultLibraryBook_ID_HasDefaultValue() {
		assertNotNull(
				"Tests that the unique ID of a library book created with the default constructor has the default value.",
				mLibraryBook.getID());
	}
	...
	public void test_DefaultLibraryBook_ISBN_HasDefaultValue() {
		...
		assertEquals(
				"Tests that the ISBN of a library book created with the default constructor has the default value.",
				expected, actual);
	}

	/**
	 * Tests that the ISBN of a library book created with the default constructor is
	 * not null.
	 */
	@Test
	...
	public void test_DefaultLibraryBook_NumberOfCopiesInStock_HasDefaultValue() {
		...
		assertEquals(
				"Tests that the number of in stock copies of a library book created with the default constructor has the default value.",
				expected, actual);
	}
	...
	public void test_DefaultLibraryBook_NumberOfCopiesInStock_IsNotNull() {
		assertNotNull(
				"Tests that the number of in stock copies of a library book created with the default constructor is not null.",
	...
	public void test_DefaultLibraryBook_NumberOfCopiesTotal_HasDefaultValue() {
		...
		assertEquals(
				"Tests that the number of total copies of a library book created with the default constructor has the default value.",
				expected, actual);
	}
	...
	public void test_DefaultLibraryBook_NumberOfCopiesTotal_IsNotNull() {
		assertNotNull(
				"Tests that the number of total copies of a library book created with the default constructor is not null.",
	...
	public void test_DefaultLibraryBook_PublishingYear_HasDefaultValue() {
		...
		assertEquals(
				"Tests that the publishing year of a library book created with the default constructor has the default value.",
				expected, actual);
	}
	...
	public void test_DefaultLibraryBook_PublishingYear_IsNotNull() {
		assertNotNull(
				"Tests that the publishing year of a library book created with the default constructor is not null.",
				mLibraryBook.publishingYearProperty());
	}

	/**
	 * Tests that the series of a library book created with the default constructor
	 * has the default value.
	 */
	@Test
	public void test_DefaultLibraryBook_Series_HasDefaultValue() {
		...
		assertEquals(
				"Tests that the series of a library book created with the default constructor has the default value.",
				expected, actual);
	}
	...
	public void test_DefaultLibraryBook_Title_HasDefaultValue() {
		...
		assertEquals(
				"Tests that the title of a library book created with the default constructor has the default value.",
				expected, actual);
	}
	...
	public void test_LibraryBook_Audience_HasCorrectAssignedValue() {
		mLibraryBook = new LibraryBook("978-0575097469", "Warbreaker", "Brandon Sanderson", new BookSeries(),
				Genre.Fantasy, Audience.Adult, 2011, Fictionality.Fiction, 1, 5);

		final Audience expected = Audience.Adult;
		final Audience actual = mLibraryBook.getAudience();

		assertEquals("Tests that the audience of a library book has the correct assigned value.", expected, actual);
	}
	...
	public void test_LibraryBook_Author_HasCorrectAssignedValue() {
		mLibraryBook = new LibraryBook("978-0765383105", "Elantris", "Brandon Sanderson", new BookSeries(),
				Genre.Fantasy, Audience.Adult, 2005, Fictionality.Fiction, 2, 3);

		final String expected = "Brandon Sanderson";
		final String actual = mLibraryBook.getAuthor();

		assertEquals("Tests that the author of a library book has the correct assigned value.", expected, actual);
	}
	...
	public void test_LibraryBook_Compares_Correctly_With_SameBook() {
		...
		try {
			...
			mLibraryBook = new LibraryBook("978-0812511819", "The Eye of the World", "Robert Jordan",
					new BookSeries("The Wheel of Time 1|14"), Genre.Fantasy, Audience.Adult, 1990, Fictionality.Fiction,
					1, 2);
			otherBook = new LibraryBook("978-0812511819", "The Eye of the World", "Robert Jordan",
					new BookSeries("The Wheel of Time 1|14"), Genre.Fantasy, Audience.Adult, 1990, Fictionality.Fiction,
					1, 2);
		...
		assertEquals("Tests that the a library book can be compared to another as expected.", expected, actual);
	}
	...
	public void test_LibraryBook_Compares_Correctly_With_Sequel() {
		...
		try {
			mLibraryBook = new LibraryBook("978-0812511819", "The Eye of the World", "Robert Jordan",
					new BookSeries("The Wheel of Time 1|14"), Genre.Fantasy, Audience.Adult, 1990, Fictionality.Fiction,
					1, 2);
			otherBook = new LibraryBook("978-0812517729", "The Great Hunt", "Robert Jordan",
					new BookSeries("The Wheel of Time 2|14"), Genre.Fantasy, Audience.Adult, 1991, Fictionality.Fiction,
					2, 2);
		} catch (final InvalidBookSeriesNameException e) {
		}
		...
		assertEquals("Tests that the a library book can be compared to it's sequel as expected.", expected, actual);
	}
	...
	public void test_LibraryBook_Fictionality_HasCorrectAssignedValue() {
		try {
			mLibraryBook = new LibraryBook("978-1524104863", "White Sand: Volume 1", "Brandon Sanderson",
					new BookSeries("White Sand 1|2"), Genre.Fantasy, Audience.YoungAdult, 2017, Fictionality.Fiction, 3,
					3);
		} catch (final InvalidBookSeriesNameException e) {
		}
	...
	public void test_LibraryBook_Genre_HasCorrectAssignedValue() {
		try {
			mLibraryBook = new LibraryBook("978-0385743570", "Steelheart", "Brandon Sanderson",
					new BookSeries("The Reckoners 1|4"), Genre.Fantasy, Audience.Adult, 2014, Fictionality.Fiction, 2,
					5);
		} catch (final InvalidBookSeriesNameException e) {
		}
		...
		assertEquals("Tests that the genre of a library book has the correct assigned value.", expected, actual);
	}
	...
	public void test_LibraryBook_ID_HasUniqueValue() {
		...
		for (int i = 0; i < 1000; i++) {
			...
			assertNotEquals("Tests that the unique ID of a library book has a unique value.", expected, actual);
		}
	...
	public void test_LibraryBook_ISBN_HasCorrectAssignedValue() {
		mLibraryBook = new LibraryBook("978-0399555770", "Skyward", "Brandon Sanderson", new BookSeries(),
				Genre.Fantasy, Audience.Adult, 2018, Fictionality.Fiction, 4, 5);

		final String expected = "978-0399555770";
		final String actual = mLibraryBook.getISBN();

		assertEquals("Tests that the ISBN of a library book has the correct assigned value.", expected, actual);
	}
	...
	public void test_LibraryBook_NumberOfCopiesInStock_HasCorrectAssignedValue() {
		try {
			mLibraryBook = new LibraryBook("978-0439925509", "Alcatraz versus the Evil Librarians", "Brandon Sanderson",
					new BookSeries("WAlcatraz versus the Evil Librarians 1|6"), Genre.Fantasy, Audience.YoungAdult,
					2007, Fictionality.Fiction, 2, 5);
		} catch (final InvalidBookSeriesNameException e) {
		}
	...
	public void test_LibraryBook_NumberOfCopiesTotal_HasCorrectAssignedValue() {
		mLibraryBook = new LibraryBook("978-0765338440", "The Rithmatist", "Brandon Sanderson", new BookSeries(),
				Genre.Drama, Audience.YoungAdult, 2012, Fictionality.Fiction, 1, 3);
	...
	public void test_LibraryBook_PublishingYear_HasCorrectAssignedValue() {
		mLibraryBook = new LibraryBook("978-1473218055", "Arcanum Unbounded: The Cosmere Collection",
				"Brandon Sanderson", new BookSeries(), Genre.Fantasy, Audience.Adult, 2017, Fictionality.Fiction, 1, 2);

		final int expected = 2017;
		final int actual = mLibraryBook.getPublishingYear();

		assertEquals("Tests that the publishing year of a library book has the correct assigned value.", expected,
				actual);
	}
	...
	public void test_LibraryBook_Series_HasCorrectAssignedValue() {
		try {
			mLibraryBook = new LibraryBook("978-0765311788", "Mistborn: The Final Empire", "Brandon Sanderson",
					new BookSeries("Mistborn: Era 1 1|3"), Genre.Fantasy, Audience.Adult, 2006, Fictionality.Fiction, 4,
					6);
		} catch (final InvalidBookSeriesNameException e) {
		}
		...
		assertEquals("Tests that the series of a library book has the correct assigned value.", expected, actual);
	}
	...
	public void test_LibraryBook_Title_HasCorrectAssignedValue() {
		try {
			mLibraryBook = new LibraryBook("978-0765326355", "The Way of Kings", "Brandon Sanderson",
					new BookSeries("The Stormlight Archive 1|10"), Genre.Fantasy, Audience.Adult, 2010,
					Fictionality.Fiction, 7, 11);
		} catch (final InvalidBookSeriesNameException e) {
		}
		...
		assertEquals("Tests that the title of a library book has the correct assigned value.", expected, actual);
	}
	...
	public void test_LibraryBook_ToString_Matches() {
		mLibraryBook = new LibraryBook("978-1616960926", "The Emperor's Soul", "Brandon Sanderson", new BookSeries(),
				Genre.Fantasy, Audience.Adult, 2012, Fictionality.Fiction, 2, 3);
		...
		assertEquals("Tests that the toString() method of a library book works as expected.", expected, actual);
	}
	...
	public void test_LibraryBookReflection_NoPublicNonFinalFields() {
		...
		for (final Field field : declaredFields) {
			if (!field.isSynthetic()
				...
				final String message = String.format("Field %s can only be public if it is also final.",
						field.getName());
