...
public class LibraryTest {
	...
	public void superficialConstantsCoverageTest() {
		...
		assertEquals("Tests that the default publishing year is a constant.", CommonConstants.DEFAULT_PUBLISHING_YEAR,
				publishingYear);
		assertEquals("Tests that the default stock is a constant.", CommonConstants.DEFAULT_STOCK, stock);

		assertEquals("Tests that the default author is a constant.", CommonConstants.DEFAULT_AUTHOR, author);
		assertEquals("Tests that the default ISBN is a constant.", CommonConstants.DEFAULT_ISBN, isbn);
		assertEquals("Tests that the default series is a constant.", CommonConstants.DEFAULT_SERIES, series);
		assertEquals("Tests that the default title is a constant.", CommonConstants.DEFAULT_TITLE, title);

		assertEquals("Tests that the default audience is a constant.", CommonConstants.DEFAULT_AUDIENCE, audience);
		assertEquals("Tests that the default fictionality is a constant.", CommonConstants.DEFAULT_FICTIONALITY,
				fictionality);
		assertEquals("Tests that the default genre is a constant.", CommonConstants.DEFAULT_GENRE, genre);
	}
