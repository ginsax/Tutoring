...
public class InheritanceTest {
	...
	public void test_HummingbirdMakeNoise() {
		...
		assertEquals(String.format("Testing that a hummingbird making noise sounds like '%s'.", expected), expected,
				actual);
	}
	...
	public void test_KangarooMakeNoise() {
		...
		assertEquals(String.format("Testing that a kangaroo making noise sounds like '%s'.", expected), expected,
				actual);
	}
	...
	public void test_ManateeMakeNoise() {
		...
		assertEquals(String.format("Testing that a manatee making noise sounds like '%s'.", expected), expected,
				actual);
	}
	...
	public void test_SurgeonFishMakeNoise() {
		...
		assertEquals(String.format("Testing that a surgeonfish making noise sounds like '%s'.", expected), expected,
				actual);
	}
}