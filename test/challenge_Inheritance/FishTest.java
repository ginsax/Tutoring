...
public class FishTest {
	...
	public void test_CanMakeNoise() {
		...
		assertEquals(
		    String.format("Testing that a fish can make a noise similar to '%s'.",
		        expected),
		    expected, actual);
	}
	...
	/**
	 * Testing that the number of fins - if not specified - is equivalent to the
	...
	public void test_NumberOfLegs_CanBeSet() {
		...
		assertEquals("Testing that the number of fins can be set to 0.", expected,
		    actual);
		...
		assertEquals("Testing that the number of fins can be set to 2.", expected,
		    actual);
	}
	...
	public void test_NumberOfLegs_CannotBeSetToInvalidValues() {
		...
		for (int i = 3; i <= 100; i++) {
			...
			assertNotEquals(
			    String.format("Testing that the number of fins cannot be set to %d.",
			        expected),
			    expected, actual);
		}
	}
	...
	public void test_SkinType_CannotBeSetToInvalidValues() {
		...
		assertEquals("Testing that the skin type cannot be set to 'Fur'.", expected,
		    actual);
