...
public class MammalTest {
	...
	public void test_DefaultNumberOfLegsIs_MinimumInteger() {
		...
		assertEquals("Testing that the number of legs - if not specified - is equivalent to the minimum integer value.", expected, actual);
	}
	/**
...
//		Tests that all numbers above 4 are invalid 
		for(int i = 5; i <= 100; i++) {
			...
			assertNotEquals(String.format("Testing that the number of legs cannot be set to %d.", expected), expected, actual);
		}
	}
