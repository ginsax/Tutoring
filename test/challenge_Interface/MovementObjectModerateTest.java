...
public class MovementObjectModerateTest {
	...
	public void test_MovementObject_Moderate_DefaultXCoordinateIsNotZero() {
		...
		final int actual = coordinates.getPositionX();
		assertNotEquals(
		    "Tests for the X coordinate of a MovementObject_Moderate being non-zero.",
		    expected, actual);
	}
	...
	public void test_MovementObject_Moderate_DefaultYCoordinateIsNotZero() {
		...
		final int actual = coordinates.getPositionY();
		assertNotEquals(
		    "Tests for the Y coordinate of a MovementObject_Moderate being non-zero.",
		    expected, actual);
	}
	...
	public void test_MovementObject_Moderate_DefaultZCoordinateIsNotZero() {
		...
		final int actual = coordinates.getPositionZ();
		assertNotEquals(
		    "Tests for the Z coordinate of a MovementObject_Moderate being non-zero.",
		    expected, actual);
	}
	...
	public void test_MovementObjectModerate_CanMove() {
		...
		assertNotEquals("Tests that the object can move in the X direction.", x,
		    newX);
		assertNotEquals("Tests that the object can move in the Y direction.", y,
		    newY);
	}
	...
	public void test_MovementObjectModerate_MovesExactly() {
		...
		assertEquals(
		    "Tests that the object moves in multiples of 3 in the X direction.",
		    expectedX, actualX);
		assertEquals(
		    "Tests that the object moves in multiples of 4 in the Y direction.",
		    expectedY, actualY);
		assertEquals(
		    "Tests that the object moves in multiples of 5 in the Z direction.",
		    expectedZ, actualZ);
	}
