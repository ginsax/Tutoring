...
public class MovementObjectModerateTest {
  ...
  public void test_MovementObject_Moderate_CoordinatesAreNotNull() {
    ...
    assertNotNull("Tests for the coordinates of a MovementObject_Moderate being non-null.",
  ...
  public void test_MovementObject_Moderate_DefaultXCoordinateCanBeSet() {
    ...
    assertEquals("Tests that the X coordinate of a MovementObject_Moderate can be set.",
                 expected,
                 actual);
  }
  
  /**
   * Tests for the default X coordinate of a MovementObject_Moderate being
   * non-zero.
   */
  @Test
  public void test_MovementObject_Moderate_DefaultXCoordinateIsNotZero() {
    ...
    final int actual = coordinates.getPositionX();
    assertNotEquals("Tests for the X coordinate of a MovementObject_Moderate being non-zero.",
                    expected,
                    actual);
  }
  ...
  public void test_MovementObject_Moderate_DefaultYCoordinateCanBeSet() {
    ...
    assertEquals("Tests that the Y coordinate of a MovementObject_Moderate can be set.",
                 expected,
                 actual);
  }
  
  /**
   * Tests for the default Y coordinate of a MovementObject_Moderate being
   * non-zero.
   */
  @Test
  public void test_MovementObject_Moderate_DefaultYCoordinateIsNotZero() {
    ...
    final int expected = defaultZeroValue;
    final int actual = coordinates.getPositionY();
    assertNotEquals("Tests for the Y coordinate of a MovementObject_Moderate being non-zero.",
                    expected,
                    actual);
  }
  ...
  public void test_MovementObject_Moderate_DefaultZCoordinateCanBeSet() {
    ...
    assertEquals("Tests that the Z coordinate of a MovementObject_Moderate can be set.",
                 expected,
                 actual);
  }
  
  /**
   * Tests for the default Z coordinate of a MovementObject_Moderate being
   * non-zero.
   */
  @Test
  public void test_MovementObject_Moderate_DefaultZCoordinateIsNotZero() {
    ...
    final int expected = defaultZeroValue;
    final int actual = coordinates.getPositionZ();
    assertNotEquals("Tests for the Z coordinate of a MovementObject_Moderate being non-zero.",
                    expected,
                    actual);
  }
  ...
  public void test_MovementObject_Moderate_NotNull() {
    ...
    assertNotNull("Tests for a MovementObject_Moderate being non-null.",
                  movement);
  }
  ...
  public void test_MovementObjectModerate_CanMove() {
    ...
    assertNotEquals("Tests that the object can move in the X direction.",
                    x,
                    newX);
    assertNotEquals("Tests that the object can move in the Y direction.",
                    y,
                    newY);
  }
  ...
  public void test_MovementObjectModerate_DisplayStringIsNotNull() {
    ...
    assertNotNull("Tests that the display string is not null.",
                  movement.createDisplayString());
  }
  
  /**
   * Tests that the object moves in multiples of the of the default value in the
  ...
  public void test_MovementObjectModerate_MovesExactly() {
    ...
    assertEquals("Tests that the object moves in multiples of 3 in the X direction.",
                 expectedX,
                 actualX);
    assertEquals("Tests that the object moves in multiples of 4 in the Y direction.",
                 expectedY,
                 actualY);
    assertEquals("Tests that the object moves in multiples of 5 in the Z direction.",
                 expectedZ,
                 actualZ);
  }
