...
public class MovementObjectSimpleTest {
  ...
  public void test_MovementObjectSimple_CoordinatesAreNotNull() {
    ...
    assertNotNull("Tests for the coordinates of a MovementObjectSimple being non-null.",
                  movement.getCoordinates());
  }
  
  /**
   * Tests that the default X coordinate of a MovementObjectSimple is equal to
   * 2.
   */
  @Test
  public void test_MovementObjectSimple_DefaultXCoordinateIsEqual() {
    ...
    assertEquals("Tests that the default X coordinate of a MovementObjectSimple is equal to 2.",
                 expected,
                 actual);
  }
  
  /**
   * Tests that the default Y coordinate of a MovementObjectSimple is equal to
   * 4.
   */
  @Test
  public void test_MovementObjectSimple_DefaultYCoordinateIsEqual() {
    ...
    assertEquals("Tests that the default Y coordinate of a MovementObjectSimple is equal to 4.",
                 expected,
                 actual);
  }
  ...
  public void test_MovementObjectSimple_MovesExactly() {
    ...
    assertEquals("Tests that the object moves exactly 1 in the X direction.",
                 newX,
                 x +
                       1);
    assertEquals("Tests that the object moves exactly 1 in the Y direction.",
                 newY,
                 y +
                       1);
  }
  ...
  public void test_MovementObjectSimple_NotNull() {
    ...
    assertNotNull("Tests for a MovementObjectSimple being non-null.",
                  movement);
  }
  ...
  public void test_MovementObjectSimple_XCoordinateIsNonZero() {
    ...
    final int actual = coordinates.getPositionX();
    assertNotEquals("Tests for the X coordinate of a MovementObjectSimple being non-zero.",
                    expected,
                    actual);
  }
  ...
  public void test_MovementObjectSimple_YCoordinateIsNonZero() {
    ...
    final int expected = defaultZeroValue;
    final int actual = coordinates.getPositionY();
    assertNotEquals("Tests for the Y coordinate of a MovementObjectSimple being non-zero.",
                    expected,
                    actual);
  }
  ...
  public void test_MovementObjectSimple_ZCoordinateIsZero() {
    ...
    assertEquals("Tests for the Z coordinate of a MovementObjectSimple being zero.",
                 expected,
                 actual);
  }
