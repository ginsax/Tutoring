...
public class PalindromeTest {
	 ...
	 *          String that was checked for being a palindrome.
	 * @param expected
	 *          The expected value.
	 * @param actual
	 *          The actual value that was returned.
	...
	private String createErrorMessage(final String potentialPalindrome,
		...
		final String errorMessage = String.format(
		    "The string '%s' was tested for being a potential palindrome. The test failed because a value of '%s' was expected, but '%s' was returned.",
		    potentialPalindrome, expected, actual);
		return errorMessage;
	}
