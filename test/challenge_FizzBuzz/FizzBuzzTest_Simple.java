...
import challenge_FizzBuzz.FizzBuzzAnalyzer_Simple;
...
public class FizzBuzzTest_Simple {
	...
	public void test_One_Returns_NoResponse() {
		...
		assertEquals("Tests that the number 1 (one) results in no response.", expected, actual);
	}
	...
	public void test_Two_Returns_NoResponse() {
		...
		assertEquals("Tests that the number 2 (two) results in no response.", expected, actual);
	}
	...
	public void test_Three_Returns_Fizz() {
		...
		assertEquals("Tests that the number 3 (three) results in 'Fizz'.", expected, actual);
	}
	...
	public void test_Five_Returns_Buzz() {
		...
		assertEquals("Tests that the number 5 (five) results in 'Buzz'.", expected, actual);
	}
	...
	public void test_Fifteen_Returns_FizzBuzz() {
		...
		assertEquals("Tests that the number 15 (fifteen) results in 'FizzBuzz'.", expected, actual);
	}
	...
	public void superficialEnumCoverageTest() {
		for(FizzBuzzAnalysisResult result : FizzBuzzAnalysisResult.values()) {
