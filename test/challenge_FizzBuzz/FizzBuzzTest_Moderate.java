...
public class FizzBuzzTest_Moderate {
	...
	public void test_Fifteen_Returns_FizzBuzz() {
		...
		assertEquals("Tests that the number 15 (fifteen) results in 'FizzBuzz' with the default analyzer.", expected,
				actual);
	}
	...
	public void test_One_Returns_NoResponse() {
		...
		assertEquals("Tests that the number 1 (one) results in no response with the default analyzer.", expected,
				actual);
	}
	...
	public void test_Two_Returns_NoResponse() {
		...
		assertEquals("Tests that the number 2 (two) results in no response with the default analyzer.", expected,
				actual);
	}
