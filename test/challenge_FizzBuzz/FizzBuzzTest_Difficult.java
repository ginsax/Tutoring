...
public class FizzBuzzTest_Difficult {
	...
	public void test_6Objects() {
		...
		final String actual = mFizzBuzzAnalyzer.analyze(fizzBuzzObject_a, fizzBuzzObject_b, fizzBuzzObject_c,
				fizzBuzzObject_d, fizzBuzzObject_e, fizzBuzzObject_f);
	...
	/**
	 * Tests that the number 1000 (one thousand) is the highest lower bounds
	 * possible.
	 */
	@Test
	public void test_OneThousand_IsHighestLowerBounds() {
		...
		final int actual = mFizzBuzzAnalyzer.getBoundsLower();
		assertEquals("Tests that the number 1000 (one thousand) is the highest lower bounds possible.", expected,
				actual);
	}

	/**
	 * Tests that the number 1000 (one thousand) is the highest upper bounds
	 * possible.
	 */
	@Test
	public void test_OneThousand_IsHighestUpperBounds() {
		...
		final int expected = 1000;
		final int actual = mFizzBuzzAnalyzer.getBoundsUpper();
		assertEquals("Tests that the number 1000 (one thousand) is the highest upper bounds possible.", expected,
				actual);
	}

	/**
	 * Tests that a FizzBuzzObject with a value of 1 will return 'Fizz' repeated
	 * 1000 times.
	 */
	@Test
	public void test_OneThousandIterations() {
		...
		assertEquals("Tests that a FizzBuzzObject with a value of 1 will return \"Fizz\" repeated 1000 times.",
				expected, actual);
	}
	...
	/**
	 * Tests that FizzBuzzObject[1, 'Fizz'] & FizzBuzzObject[2, 'Buzz'] return
	 * correctly.
	 */
	@Test
	public void test_TwoObjects_1Fizz_2Buzz() {
		...
		final String actual = mFizzBuzzAnalyzer.analyze(fizzBuzzObject_a, fizzBuzzObject_b);
		assertEquals("Tests that FizzBuzzObject[1, 'Fizz'] & FizzBuzzObject[2, 'Buzz']  return correctly.", expected,
				actual);
	}

	/**
	 * Tests that FizzBuzzObject[1, 'Fizz'] & FizzBuzzObject[2, 'Buzz'] sort &
	 * return correctly.
	 */
	@Test
