...
public class FizzBuzzTest_Difficult {
  ...
  public void test_One_IsLowestLowerBounds() {
    ...
    assertEquals("Tests that the number 1 (one) is the lowest bounds possible.",
                 expected,
                 actual);
  }
  ...
  public void test_One_IsLowestUpperBounds() {
    ...
    assertEquals("Tests that the number 1 (one) is the lowest upper bounds possible.",
                 expected,
                 actual);
  }
  ...
  public void test_OneThousand_IsHighestLowerBounds() {
    ...
    final int actual = mFizzBuzzAnalyzer.getBoundsLower();
    assertEquals("Tests that the number 1000 (one thousand) is the highest lower bounds possible.",
                 expected,
                 actual);
  }
  ...
  public void test_OneThousand_IsHighestUpperBounds() {
    ...
    final int expected = 1000;
    final int actual = mFizzBuzzAnalyzer.getBoundsUpper();
    assertEquals("Tests that the number 1000 (one thousand) is the highest upper bounds possible.",
                 expected,
                 actual);
  }
  ...
  public void test_OverridesToString() {
    ...
    assertEquals("Tests that a FizzBuzzObject overrides 'toString()' method.",
                 expected,
                 actual);
  }
