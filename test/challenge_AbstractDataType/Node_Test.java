...
public class Node_Test {
  ...
  /**
   * Tests that a {@linkplain Nodeable} created with the default constructor is not null. 
   */
  @Test
  public void test_NodableDefaultConstructor_IsNotNull() {
    final Nodeable<Integer> node = new Node<Integer>();
    
    assertNotNull(node);
  }
  /**
   * Tests that the next node of a {@linkplain Nodeable} created with the 
  ...
  /**
   * Tests that the data object of a {@linkplain Nodeable} created with the 
   * default constructor is null. 
   */
  @Test
  ...
  public void test_Nodable_NodeConstructor_DataObject_IsNull() {
    final Nodeable<Integer> nodeB = new Node<Integer>();
    final Nodeable<Integer> nodeA = new Node<Integer>(nodeB);
  ...
  public void test_Nodable_NodeConstructor_NextNode_IsNotNull() {
    final Nodeable<Double> nodeB = new Node<Double>();
    final Nodeable<Double> nodeA = new Node<Double>(nodeB);
    
    final Nodeable<Double> expected = nodeB;
    final Nodeable<Double> actual = nodeA.getNextNode();
  ...
  public void test_Nodable_DataObjectConstructor_DataObject_IsNotNull() {
    ...
    final Nodeable<Double> nodeA = new Node<Double>(dataObject);
  ...
  public void test_Nodable_DataObjectConstructor_DataObject_HasSetValue() {
    ...
    final Nodeable<Double> node = new Node<Double>(dataObject);
  ...
  public void test_Nodable_ParameterizedConstructor_DataObject_IsNotNull() {
    ...
    final Nodeable<Double> nodeB = new Node<Double>(dataObjectB);
    
    final Double dataObjectA = new Double(69.69);
    final Nodeable<Double> nodeA = new Node<Double>(nodeB, dataObjectA);
  ...
  /** Tests that the data object of a {@linkplain Nodeable} can be set. */
  @Test
  public void test_Nodable_DataObject_CanBeSet() {
    final Double expected = new Double(69.69);
    
    final Nodeable<Double> node = new Node<Double>();
    node.setDataObject(expected);
    
    final Double actual = node.getDataObject();
    assertEquals(expected, actual);
  }
  /** Tests that the next node of a {@linkplain Nodeable} can be set. */
  @Test
  public void test_Nodable_NextNode_CanBeSet() {
    final Nodeable<String> nodeA = new Node<String>();
    final Nodeable<String> nodeB = new Node<String>();
    
    nodeA.setNextNode(nodeB);
    
    final Nodeable<String> expected = nodeB;
    final Nodeable<String> actual = nodeA.getNextNode();
    assertEquals(expected, actual);
  }
}