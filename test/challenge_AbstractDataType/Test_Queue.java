...
public class Test_Queue {
	...
	public void test_QueueableConstructor_NodesAreOrderedAsExpected_01() {
		final Integer[] nodesToAdd = new Integer[] { new Integer(5), new Integer(6),
		    new Integer(9), new Integer(129), new Integer(72), new Integer(-5),
		    new Integer(234), new Integer(90), };
	...
	public void test_QueueableConstructor_NodesAreOrderedAsExpected_03() {
		final Double[] nodesToAdd = new Double[] { new Double(50.293),
		    new Double(61.4810), new Double(9.019), new Double(1.0000000001),
		    new Double(72.1234), new Double(-33.0), new Double(234.0),
		    new Double(90.), };
	...
	public void test_QueueableConstructor_NodesAreOrderedAsExpected_04() {
		final Animal[] nodesToAdd = new Animal[] { new Mammal(), new Bird(),
		    new Fish(), new Kangaroo(), new Eel(), new Hummingbird(), new Manatee(),
		    new SurgeonFish(), };
